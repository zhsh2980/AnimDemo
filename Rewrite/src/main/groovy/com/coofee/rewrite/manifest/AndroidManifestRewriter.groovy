...
import com.coofee.rewrite.manifest.handler.ReplaceContentProviderHandler
            ...
            variant.outputs.each { output ->
                ...
                processManifest.doLast { task ->
                    ...
                    List<AndroidManifestHandler> handlerList = [
                            ...
                            new ReplaceContentProviderHandler(packageName, manifestExtension.replaceContentProviders)
                    ]
