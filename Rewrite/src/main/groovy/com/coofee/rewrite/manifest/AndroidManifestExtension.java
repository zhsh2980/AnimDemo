...
public class AndroidManifestExtension {
    ...
    /**
     * 需要替换的content provider
     */
    public Map<String, String> replaceContentProviders;
    ...
    public boolean equals(Object o) {
        ...
        if (mustExportedComponents != null ? !mustExportedComponents.equals(that.mustExportedComponents) : that.mustExportedComponents != null)
            return false;
        if (replaceContentProviders != null ? !replaceContentProviders.equals(that.replaceContentProviders) : that.replaceContentProviders != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (replaceContentProviders != null ? replaceContentProviders.hashCode() : 0);
    ...
    public String toString() {
        return "AndroidManifestExtension{" +
                ...
                ", replaceContentProviders=" + replaceContentProviders +
                '}';
    }
}
