...
public class ReplaceMethodExtension {
    ...
    public boolean equals(Object o) {
        ...
        return enable == that.enable && Objects.equals(excludes, that.excludes) && Objects.equals(configFile, that.configFile) && Objects.equals(outputFile, that.outputFile);
    }

    @Override
    public int hashCode() {
        return Objects.hash(enable, excludes, configFile, outputFile);
    }
