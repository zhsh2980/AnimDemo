...
/**
 * Created by zhangshan on 2018/11/18 21:40.
 */
public class RoundAngleFrameLayout extends FrameLayout {
    ...
    public RoundAngleFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            topLeftRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_round_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_round_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_round_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundAngleFrameLayout_round_bottomRightRadius, radius);
            ta.recycle();
        }
