...
import anim.bro.com.practice.util.HideShopAnimUtil;
import anim.bro.com.practice.util.RedNewAnimView;
import anim.bro.com.practice.util.UIUtils;
import anim.bro.com.practice.view.ClipProgressView;
import anim.bro.com.practice.view.Rotate3dAnimation;
import anim.bro.com.practice.view.RoundView;
import anim.bro.com.practice.view.SwapAnimImageView;
import anim.bro.com.practice.view.TransTextView;
...
public class RedNewActivity extends AppCompatActivity {
    ...
    TransTextView mIvClipView;
    @BindView(R.id.btn_clip)
    Button mBtnClip;
    @BindView(R.id.iv_clip_view_2)
    TransTextView mIvClipView2;
