...
/**
 * Created by zhangshan on 2019/3/26 19:22.
 */
public class RoundImageView extends AppCompatImageView {


    //圆角大小，默认为10
    private int mBorderRadius = UIUtils.dip2px(8);
    ...
    public void setmBorderRadius(int borderRadiusDp) {
        this.mBorderRadius = UIUtils.dip2px(borderRadiusDp);
    }
}
